  ...
  return {
    ...
    content: function (config, pack) {
      ...
      get.PS_pingze = function (str) {
        const ping = ['ā', 'á', 'ē', 'é', 'ī', 'í', 'ō', 'ó', 'ū', 'ú'];
      ...
      //emotion分类
      lib.emotionSort = {
        happy: {//高兴（天过、拼点赢、一次摸两张牌）
          'guojia_emotion': [3, 13, 18, 19],
          'shibing_emotion': [2, 5],
          'zhenji_emotion': [2, 11, 13],
          'xiaojiu_emotion': [11, 12, 20],
          'xiaosha_emotion': [9, 14, 15, 16],
          'xiaotao_emotion': [5, 14, 18],
          'xiaowu_emotion': [7],
        },
        angry: {//生气（受到2点伤害、被弃置、被获得)            
          'guojia_emotion': [8],
          'shibing_emotion': [9],
          'zhenji_emotion': [12, 20],
          'xiaojiu_emotion': [6, 18],
          'xiaosha_emotion': [12],
          'xiaotao_emotion': [15],
          'xiaowu_emotion': [1, 8],
        },
        sad: {//难过（翻面、阶段被跳过）
          'guojia_emotion': [5, 9, 20],
          'shibing_emotion': [1, 7, 11],
          'zhenji_emotion': [10, 14, 19],
          'xiaojiu_emotion': [5, 14, 16],
          'xiaosha_emotion': [2, 6, 11],
          'xiaotao_emotion': [2, 10, 11],
          'xiaowu_emotion': [10, 12, 14],
        },
        thunderstruck: {//被雷击
          'guojia_emotion': 6,
          'shibing_emotion': 8,
      ...
      game.PS_checkVersion = function () {
        ...
        const result = compareVersions("1.10.2", lib.version);
        if (result > 0) {
          alert(`你的游戏版本是: ${lib.version}，当前扩展兼容的本体游戏版本是: 1.10.2 请更新游戏版本，以免出现功能异常或错误.`);
        }
      }
          ...
          var PScharacter = {
            ...
            characterSort: {
              PScharacter: {
                ...
                PScharacter_shu: ['PSsh_zhangfei', 'PStongxiangge', 'PSrs_wolong', 'PShuangyueying', 'PSzhaoxiang', 'PSzhangsong', 'PSguanyunchang', 'PSzhaoyun', 'PSzhuangbeidashi', 'PSguanyu', 'PSmeng_liubei'],
                ...
                PScharacter_qun: ['PSzhangjiao', 'PSlibai', 'PSyuanshu', 'PSxushao', 'PSguanning', 'PSliru', 'PSzuoci', 'PSerciyuan', 'PSdahantianzi', 'PSyeshou', 'PSnanhualaoxian', 'PSduyu', 'PSzhangrang', 'PSqun_sunce', 'PSgaoguimingmen', 'PSsishouyige', 'PSyangbiao', 'PSguosi', 'PSpeixiu', 'PSsb_xushao', 'PSjiaxu', 'PSxuyou'],
            ...
            character: {
              ...
              PSsunshangxiang: ["female", "wu", 3, ["xiaoji", "PSjieyin"], []],
              ...
              PSyeshou: ["male", "qun", 4, ["PSechou", "PSjuexing"], []],//待补充
              ...
              PScaojinyu: ["female", "wei", 4, ["PSyuqi", "PSshanshen", "PSxianjing"], []],
              ...
              PSlibai: ["male", "qun", 3, ["dclbjiuxian", "PSshixian"], []],
              PSxie_sunquan: ["male", "wu", 4, ["PSzongheng", "PSxiqu", "PSchengchen"], ["die:../audio/die/re_sunquan.mp3"]],
            },
            characterIntro: {
              PSzhaoxiang: '开启扩展“天牢令”体验更佳',
              'PSsb_xushao': '开启扩展“天牢令”体验更佳',
              db_PSdaweiwuwang: '开启扩展“天牢令”体验更佳',
              'PSshen_zhangliao': '开启扩展“天牢令”体验更佳',
            },//武将介绍
            characterTitle: {
            },//武将称号
            characterReplace: {
            ...
            skill: {
              ...
              PSjieyin: {
                ...
                filterTarget: function (card, player, target) {
                  ...
                  if (target.countGainableCards(player, 'hej') <= 0) return false;
                  return true;
                },
                content: function () {
                  player.gainPlayerCard(get.prompt('PSjieyin', target), target, 'hej', 'visibleMove');
              ...
              PSqingxi: {
                ...
                subSkill: {
                  ...
                  summer: {
                    ...
                    content: function () {
                      player.storage.PSbenxi_damage.remove(trigger.card);
                    },
                    forced: true,
                    popup: false,
                  },
              ...
              PSechou: {
                ...
                "prompt2": function (event, player) {
                  if (player.storage.PSjuexing) return '将伤害值改为1919810，且' + get.translation(event.player) + '的防具和非锁定技失效直到伤害结算完毕';
                  return '将伤害值改为114514';
                },
                content: function () {
                  player.say('哼~哼~哼~啊啊啊啊啊————');
                  if (player.storage.PSjuexing) {
                    trigger.num = 1919810;
                    trigger.player.addTempSkill('fengyin', "damageEnd");
                    trigger.player.addTempSkill('PSechou_targeted', "damageEnd");
                  }
              ...
              PSlongnu: {
                ...
                intro: {
                  content: function (storage, player, skill) {
                    if (player.storage.PSlongnu == true) return '锁定技，出牌阶段开始时，你减1点体力上限并摸一张牌，然后本阶段内你的锦囊牌均视为雷杀且无使用次数限制，并视为拥有技能〖厉勇〗';
                    return '锁定技，出牌阶段开始时，你流失一点体力并摸一张牌，然后本阶段内你的红色手牌均视为火杀且无距离限制，并视为拥有技能〖怒斩〗';
                  },
                },
                audio: "nzry_longnu",
                trigger: {
              ...
              PSwengua: {
                ...
                subSkill: {
                  ...
                  tag: {
                    ...
                    onremove: function () {
                      player.removeGaintag(trigger.cards, "wengua");
                    },
                    "audioname2": {
                      "old_yuanshu": "weidi",
                    },
              ...
              PSshixian: {
                ...
                locked: false,
                filter: function (event, player) {
                  player.storage.PSshixian = get.PS_pingze(get.translation(event.card.name));
                  ...
                  return get.PS_pingze(get.translation(event.card.name)) !== get.PS_pingze(get.translation(evt.card.name));
                },
                  ...
                  aiOrder: function (player, card, num) {
                    if (typeof card == 'object' && !get.tag(card, 'norepeat')) {
                      ...
                      if (history.length > 0) {
                        ...
                        if (get.PS_pingze(get.translation(event.card.name)) !== get.PS_pingze(get.translation(evt.card.name))) return num + 20;
                      }
                    }
                  },
                },
            ...
            translate: {
              ...
              "PScharacter_shu": '<span style="color:#ff5400;font-family:xingkai;font-size:24px">汉祚延绵</span>',
              "PScharacter_wu": '<span style="color:#338c00;font-family:xingkai;font-size:24px">江东铁壁</span>',
              "PScharacter_qun": '<span style="color:#8c8c8c;font-family:xingkai;font-size:24px">群雄逐鹿</span>',
              "PScharacter_jin": '<span style="color:#991cff;font-family:xingkai;font-size:24px">三分归晋</span>',
              "PScharacter_shen": '<span style="color:#dc9e18;font-family:xingkai;font-size:24px">神话再临</span>',
              "PScharacter_db": '<span style="color:#ffffff;font-family:xingkai;font-size:24px">不臣</span>',
              PSshouyige: "双倍收益哥",
              PSrexusheng: "PS大宝",
              PSsunquan: "PS孙权",
              PScaocao: "PS曹操",
              ...
              "PSshixian": "诗仙",
              "PSshixian_info": "当你使用一张牌时，若此牌牌名的最后一个字的平仄声与你于本局游戏使用的上一张牌牌名的最后一个字的平仄声不同，则你可以摸一张牌，并令此牌额外结算一次。",
              "PSpaiyi_backup": "权术",
              "PSquanshu": "权术",
              ...
              PSjieyin: "结姻",
              "PSjieyin_info": "出牌阶段，你可以选择一名已经受伤的男性角色。你获得其区域内一张牌并与其各回复一点体力。若你没回复体力，则摸一张牌。",
              PSliangquan: "两全",
              ...
              PSdunshi: "遁世",
              "PSdunshi_info": "每回合限一次。你可以视为使用或打出一张基本牌或普通锦囊牌，然后当前回合角色于本回合内下一次造成伤害时，你选择两项：<br/>⒈防止此伤害。系统从技能描述中包含“出牌/受伤/结束”字样的技能中随机选择4个其未拥有的技能，然后你令当前回合角色获得其中一个技能。<br/>⒉从〖遁世〗中删除你本次使用或打出的牌并获得一个“席”。<br/>⒊减1点体力上限并摸X张牌（X为你的“席”数）。",
              PSjueyan: "决偃",
              ...
              PSechou: "恶臭",
              "PSechou_info": "当你造成伤害时，你可以将伤害值改为114514。",
              PSyufeng: "御风",
              ...
              PSzailaiyici: "再来一次",
              "PSzailaiyici_info": "一名角色使用基本牌或普通锦囊牌结算指定第一个目标后，你可令此牌额外结算一次。",
              PSweizhen: "威震",
              ...
              PStongli: "同礼",
              "PStongli_info": "出牌阶段，当你使用基本牌或普通锦囊牌指定第一个目标后，你可令此牌效果额外执行X次（X为你的手牌数）。",
              PSlianhuo: "链祸",
              ...
              PSluoying: "落英",
              "PSluoying_info": "锁定技：你立即获得任何方式进入弃牌堆的♣牌（包括自己），以此法获得牌不计入手牌上限。",
              PSbaiban: "白板",
              ...
              PSkefu: "克复",
              "PSkefu_info": "你可以将X张牌当作不计入次数的【杀】使用或打出（X为你当前体力值），此【杀】造成伤害后你回复一点体力，若不能回复则增加一点体力上限。",
              "PSjingjia1": "精甲",
              ...
              PSjuexing: "撅醒",
              "PSjuexing_info": "撅醒技，当你击杀一名角色后，你升级〖恶臭〗。",
              "PSechou_1": "恶臭·升级",
              "PSechou_1_info": "当你造成伤害时，你可以将伤害值改为1919810，然后令目标角色的非锁定技和防具失效，直到伤害结算完毕。",
              PSluanwu: "乱武",
            ...
            dynamicTranslate: {
              ...
              //野兽先辈〖恶臭〗动态翻译
              PSechou: function (player) {
                if (player.storage.PSjuexing) return '当你造成伤害时，你可以将伤害值改为1919810，然后令目标角色的非锁定技和防具失效，直到伤害结算完毕。';
              ...
              PSlingce: function (player) {
                if (player.player.storage.PSlingce) return '锁定技，当牌堆洗牌时，你观看牌堆顶8张牌，并从中获得牌名不同的牌，剩余的牌进入弃牌堆。';
      ...
      "pswj_jieshao": {
        name: '<b>欢迎关注</b><span style="color:#87CEEB"><font size="4px">▶▶▶</font></span>',
        clear: true,
        onclick: function () {
          if (this.jieshao == undefined) {
            var more = ui.create.div('.jieshao', '<div style="border:2px solid gray"><span><img style=width:238px src=' + lib.assetURL + 'extension/PS武将/pswj_jieshao.jpg></span>');
            this.parentNode.insertBefore(more, this.nextSibling);
            this.jieshao = more;
            this.innerHTML = '<span style="color:#87CEEB"><font size="4px">▼▼▼</font></span>';
          } else {
            this.parentNode.removeChild(this.jieshao);
            delete this.jieshao;
            this.innerHTML = '<b>欢迎关注</b><span style="color:#87CEEB"><font size="4px">▶▶▶</font></span>';
          };
        },
      },
      ...
      "pswj_jiaqun": {
        name: '<b>欢迎加群</b><span style="color:#87CEEB"><font size="4px">▶▶▶</font></span>',
        clear: true,
        onclick: function () {
          if (this.jiaqun == undefined) {
            var more = ui.create.div('.jiaqun', '<div style="border:2px solid gray"><span><img style=width:238px src=' + lib.assetURL + 'extension/PS武将/pswj_jiaqun.jpg></span>');
            this.parentNode.insertBefore(more, this.nextSibling);
            this.jiaqun = more;
            this.innerHTML = '<span style="color:#87CEEB"><font size="4px">▼▼▼</font></span>';
          } else {
            ...
            delete this.jiaqun;
            this.innerHTML = '<b>欢迎加群</b><span style="color:#87CEEB"><font size="4px">▶▶▶</font></span>';
          };
        },
      },
      ...
      "pswj_hudong": {
        "name": "<b>表情互动</b>",
        "intro": "开启后玩家与ai在特定场景会触发emotion表情（即时生效）",
        "init": lib.config.pswj_hudong === undefined ? false : lib.config.pswj_hudong,
        onclick: function (item) {
          game.saveConfig('pswj_hudong', item);
          game.saveConfig('extension_PS武将_pswj_hudong', item);
        },
      },

      //编辑武将，搬运自“活动武将”，已得到原作者允许，感谢萌新（转型中）
      "edit_PScharacters": {
        name: '<b><span style="text-decoration: underline">编辑将池</span></b>',
        clear: true,
        onclick: function () {
      ...
      intro: "版本：2.0.8<br/>此扩展的技能创意来自于本人，b站网友和群友的脑洞设计，由作者本人编写代码。如果你在游玩过程中遇到bug，敬请谅解，同时可以通过b站和qq群向作者本人反馈。",
      author: "九个芒果",
      diskURL: "",
      forumURL: "",
      version: "2.0.8",
